  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen text-white overflow-hidden">
      ...
      <div className="relative bg-black bg-opacity-50 p-10 rounded-lg shadow-lg text-center animate-fade-in z-10">
        <h1 className="text-3xl font-bold">You are about to be redirected to the coolest atheist server ever!</h1>
        <div className="quote text-xl italic mt-4">{quote}</div>
        <div className="redirecting-message text-lg font-semibold mt-4">Redirecting in {seconds} seconds...</div>
      </div>
      <style jsx>{`
                @keyframes fade-in {
                    from {
                ...
                .bg-stars {
                    // background-image: url('/stars.jpg'); /* Ensure you have a stars.png image in the public folder */

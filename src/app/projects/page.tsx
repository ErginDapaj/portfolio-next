...
export default function About() {
  ...
  const projectData: Project[] = [
    ...
    {
      name: "MrMoth Academy",
      description: "A website made with Express, doesn't use any framework. (OS)",
  ...
  return (
    <div>
      ...
      <Card className="mb-8" style={{ background: 'linear-gradient(45deg, #1F2937, #2D3748)' }}>
  <CardHeader
    title={
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-folder mr-2">

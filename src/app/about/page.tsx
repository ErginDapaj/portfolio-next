      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card style={{ backgroundColor: '#1F2937' }}>
            ...
            <CardContent>
              <Typography variant="body1" className="text-white">
                I've been passionate about programming since a young age. At just 13 years old, I started modding games with C# which sparked my interest in the programming world. I was fascinated by the magic of programming and the ability it gave me to create something from scratch.

                As time passed, I found myself working on Discord bots using Node.js and eventually built a dashboard for my bot site. Over the years, I have honed my skills in web development and have built dozens of websites as a freelancer on platforms like Fiverr. Even today, web development is one of my favorite things to do and I continue to work on it as a side hustle. The satisfaction of building something from scratch and seeing it come to life never gets old.
              </Typography>
            </CardContent>
          </Card>
          <Card style={{ backgroundColor: '#1F2937' }}>
            ...
            <CardContent>
              <Typography variant="body1" className="text-white">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in neque vestibulum, vestibulum libero vel, ultrices urna. Praesent ultrices est ut risus ornare, vel gravida mi lobortis. Nunc vitae magna et ex consectetur sagittis.
              </Typography>
            </CardContent>
          </Card>
        </div>
